...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        public static void Load()
        {
            ...
            if(graphData == null)
            {
                EditorUtility.DisplayDialog(
                    ...
                    "El archivo en la siguiente ubicación no se pudo cargar:\n\n"+
                    $"Assets/Editor/DialogueSystem/Graphs/{graphFileName}\n\n" +
                    "Asegúrate que seleccionaste el archivo correcto y que está en la carpeta de arriba.",
                    "Está bien"
                    );
        ...
        private static void UpdateOldGroups(List<string> currentGroupName, DSGraphSaveDataSO graphData)
        {

            if(graphData.OldGroupNames != null && graphData.OldGroupNames.Count != 0)
            {
                List<string> groupsToRemove = graphData.OldGroupNames.Except(currentGroupName).ToList();
            ...
            graphData.OldGroupNames = new List<string>(currentGroupName);
        ...
        private static List<DSDialogueChoiceData> ConvertNodeChoicesToDialogueChoices(List<DSChoiceSaveData> nodChoices)
        {

            List<DSDialogueChoiceData> dialogueChoices = new List<DSDialogueChoiceData>();
            foreach (DSChoiceSaveData nodeChoice in nodChoices)
            {
